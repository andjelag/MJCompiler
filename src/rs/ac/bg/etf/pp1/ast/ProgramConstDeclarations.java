...
public class ProgramConstDeclarations extends ProgDeclList {

    private ProgDeclList ProgDeclList;
    private ConstDecl ConstDecl;

    public ProgramConstDeclarations (ProgDeclList ProgDeclList, ConstDecl ConstDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ProgramConstDeclarations(\n");
